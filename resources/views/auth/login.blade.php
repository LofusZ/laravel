        ...
        <section>
            <div class="page-header min-vh-100">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Entrez votre email et mot de passe pour vous connecter au panel</p>
                                </div>
                                <div class="card-body">
              ...
              background-size: cover;">
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">LaraLofus</h4>
                                <p class="text-white position-relative">Laravel starter kit avec gestion d'utilisateurs et de permissions / roles.</p>
                            </div>
                        </div>
                    </div>
                </div>
